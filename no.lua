...
-- **CRITICAL FIX: Patch VirtualUser BEFORE the source executes**
local VirtualUser = game:GetService("VirtualUser")
if VirtualUser then
    -- Use rawset to bypass any restrictions
    pcall(function()
        rawset(VirtualUser, "ClickButton2D", function(self, button)
            pcall(function()
...
-- **Also patch it globally**
pcall(function()
    getfenv().VirtualUser = VirtualUser
    getfenv().ClickButton2D = function() end
end)
...
local source = [[
    ...
    -- **PATCH VirtualUser INSIDE the source too**
    local VirtualUser = game:GetService("VirtualUser")
